...
INT CMySocket::Recv(SOCKET sDstScok, _OUT_ std::tstring& strBuf, _IN_ DWORD dwSize)
{
    strBuf = TEXT("");
...
BOOL CMySocket::RecvAll(SOCKET sDstScok, _OUT_ std::tstring& strBuf, DWORD dwSize)
{
    BOOL bRet = FALSE;
